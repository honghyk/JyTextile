...
data class RollTable(
    ...
    override val items: List<com.erp.trillion.core.ui.model.RollTableItem> = emptyList(),
) : com.erp.trillion.core.ui.model.Table
...
) : com.erp.trillion.core.ui.model.TableItem

fun FabricRoll.toTableItem() = com.erp.trillion.core.ui.model.RollTableItem(
    id = id,
    orderNo = orderNo,
    itemNo = itemNo,
    color = color,
