...
fun <T> PaginatedFixedTable(
    ...
    PanelSurface(modifier = modifier) {
        Column {
            ...
            HorizontalDivider(color = JyTheme.color.divider)
            Pagination(
                onNext = onNext,
    ...
    Row(
        ...
        PaginationButton(onClick = onPrevious) {
            Icon(
                ...
                imageVector = vectorResource(resource = JyIcons.ArrowLeft),
        ...
        PaginationButton(onClick = onNext) {
            ...
            Icon(
                modifier = Modifier.size(20.dp),
                imageVector = vectorResource(resource = JyIcons.ArrowRight),
                contentDescription = null,
            )
        }
    }
...
private fun PaginationButton(
    ...
    JyOutlinedButton(
        ...
        colors = JyButtonDefaults.outlinedButtonColors().copy(
            contentColor = Palette.grey700,
        ),
        contentPadding = PaddingValues(horizontal = 12.dp, vertical = 8.dp),
        content = {
            ProvideTextStyle(JyTheme.typography.textMedium) {
                content()
            }
        }
    )
