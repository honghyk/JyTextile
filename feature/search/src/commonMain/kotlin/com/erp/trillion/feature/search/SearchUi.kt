...
import com.erp.trillion.core.designsystem.component.EmptyContent
            ...
            when {
                ...
                state.searchResults.items.isEmpty() -> {
                    PanelSurface {
                        EmptyContent(
                            modifier = Modifier.fillMaxSize(),
                            image = vectorResource(TrillionIcons.SearchEmpty),
                            text = "\"검색 결과가 없습니다.\"",
                        )
                    }
                }
...
private fun SearchResultTable(
    searchResults: com.erp.trillion.core.ui.model.RollTable,
    onRollClick: (TableItem) -> Unit,
